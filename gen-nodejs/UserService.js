...
UserService_getUser_args.prototype[Symbol.for("read")] = function(input) {
...
UserService_getUser_args.prototype[Symbol.for("write")] = function(output) {
...
UserService_getUser_result.prototype[Symbol.for("read")] = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
...
UserService_getUser_result.prototype[Symbol.for("write")] = function(output) {
...
UserServiceClient.prototype.getUser = function(request, callback) {
...
UserServiceClient.prototype.send_getUser = function(request) {
...
UserServiceProcessor.prototype.process_getUser = function(seqid, input, output) {
  ...
  if (this._handler.getUser.length === 1) {
    ...
    this._handler.getUser(args.request, function (err, result) {
      var result_obj;
